var app = {
  ...
  , setCookie = function(e, a) {
    var t = new Date
      , s = t.getTime() + 36e6;
    t.setTime(s),
    document.cookie = e + "=" + a + ";expires=" + t.toUTCString() + ";path=/"
}
  ...
  , setInnerHTML = function(e, a) {
    ...
    Array.from(e.querySelectorAll("script")).forEach((e=>{
        ...
        Array.from(e.attributes).forEach((e=>a.setAttribute(e.name, e.value))),
  ...
  , handleScrollbar = function() {
    "use strict";
    for (var e = document.querySelectorAll("[" + app.scrollBar.attr + "]"), a = 0; a < e.length; a++)
    ...
    e.map((function(t) {
        t.onclick = function(t) {
            ...
            e.map((function(e) {
                ...
                t !== s && (slideUp(t, a),
                t.closest("." + app.sidebar.menu.itemClass).classList.remove(app.sidebar.menu.expandClass),
                t.closest("." + app.sidebar.menu.itemClass).classList.add(app.sidebar.menu.closedClass))
            }
            ));
            var l = s.closest("." + app.sidebar.menu.itemClass);
            l.classList.contains(app.sidebar.menu.expandClass) || l.classList.contains(app.sidebar.menu.activeClass) && !s.style.display ? (l.classList.remove(app.sidebar.menu.expandClass),
            l.classList.add(app.sidebar.menu.closedClass),
            slideToggle(s, a)) : (l.classList.add(app.sidebar.menu.expandClass),
  ...
  , handleSidebarMenu = function() {
    ...
    var e = document.querySelector("." + app.sidebar.class + ":not(." + app.sidebarEnd.class + ")")
      ...
      , t = (e && e.getAttribute(app.sidebar.menu.disableAutoCollapseAttr),
    "." + app.sidebar.class + " ." + app.sidebar.menu.class + " > ." + app.sidebar.menu.itemClass + "." + app.sidebar.menu.hasSubClass)
  ...
  , handleSidebarEndToggle = function() {
    ...
    [].slice.call(document.querySelectorAll("[" + app.sidebarEnd.toggleAttr + "]")).map((function(e) {
        e.onclick = function(e) {
            ...
            a.contains(app.sidebarEnd.toggledClass) || a.contains(app.sidebarEnd.collapsedClass) ? a.contains(app.sidebarEnd.toggledClass) ? (a.remove(app.sidebarEnd.toggledClass),
            a.add(app.sidebarEnd.collapsedClass)) : (a.remove(app.sidebarEnd.collapsedClass),
            a.add(app.sidebarEnd.toggledClass)) : a.add(app.sidebarEnd.collapsedClass)
        }
    }
    )),
  ...
  , handleSidebarMinify = function() {
    ...
    [].slice.call(document.querySelectorAll("[" + app.sidebar.minify.toggleAttr + "]")).map((function(e) {
        e.onclick = function(e) {
            ...
            var a = document.querySelector("." + app.class).classList
              , t = !1;
            a.contains(app.sidebar.minify.toggledClass) ? a.remove(app.sidebar.minify.toggledClass) : (a.add(app.sidebar.minify.toggledClass),
            t = !0),
  ...
  , handlePanelAction = function() {
    ...
    [].slice.call(document.querySelectorAll("[" + app.panel.toggle.expand.attr + "]")).map((function(a) {
        ...
        a.onclick = function(a) {
            ...
            document.body.classList.contains(app.panel.expandClass) && t.classList.contains(app.panel.expandClass) ? (document.body.classList.remove(app.panel.expandClass),
            t.classList.remove(app.panel.expandClass),
            t.removeAttribute("style"),
            s.removeAttribute("style")) : (document.body.classList.add(app.panel.expandClass),
  ...
  , handlePanelDraggable = function() {
    ...
    if (jQuery) {
        ...
        $(e).sortable({
            ...
            connectWith: t,
            stop: function(e, a) {
                a.item.find("." + app.panel.titleClass).append(app.panel.draggable.spinnerHtml),
  ...
  , handelTooltipPopoverActivation = function() {
    "use strict";
    if (0 !== document.querySelectorAll("[" + app.bootstrap.tooltip.attr + "]").length)
        [].slice.call(document.querySelectorAll("[" + app.bootstrap.tooltip.attr + "]")).map((function(e) {
            return new bootstrap.Tooltip(e)
        }
        ));
    if (0 !== document.querySelectorAll("[" + app.bootstrap.popover.attr + "]").length)
  ...
  , handleThemePanel = function() {
    ...
    (e = [].slice.call(document.querySelectorAll("." + app.themePanel.class + " [" + app.themePanel.theme.toggleAttr + "]"))) && e.map((function(e) {
        e.onclick = function() {
            ...
            [].slice.call(document.querySelectorAll("." + app.themePanel.class + " [" + app.themePanel.theme.toggleAttr + "]")).map((function(a) {
    ...
    (a = document.querySelector("." + app.themePanel.class + " [" + app.themePanel.themeHeaderFixed.toggleAttr + "]")) && (a.onchange = function() {
        this.checked ? document.querySelector("." + app.class).classList.add(app.themePanel.themeHeaderFixed.class) : (document.querySelector("[" + app.themePanel.themeSidebarFixed.toggleAttr + "]").checked && !app.isMobile && (alert(app.themePanel.themeHeaderFixed.errorMessage),
    ...
    (a = document.querySelector("." + app.themePanel.class + " [" + app.themePanel.themeSidebarGrid.toggleAttr + "]")) && (a.onchange = function() {
        this.checked ? document.querySelector("." + app.sidebar.class).classList.add(app.themePanel.themeSidebarGrid.class) : document.querySelector("." + app.sidebar.class).classList.remove(app.themePanel.themeSidebarGrid.class),
    ...
    (a = document.querySelector("." + app.themePanel.class + " [" + app.themePanel.themeSidebarFixed.toggleAttr + "]")) && (a.onchange = function() {
        ...
        alert(app.themePanel.themeSidebarFixed.mobileErrorMessage)) : (this.checked ? (document.querySelector("." + app.themePanel.class + " [" + app.themePanel.themeHeaderFixed.toggleAttr + "]").checked || (alert(app.themePanel.themeSidebarFixed.errorMessage),
        ...
        generateScrollbar(document.querySelector(e))) : (document.querySelector("." + app.class).classList.remove(app.themePanel.themeSidebarFixed.class),
    ...
    getCookie(app.themePanel.themeDarkMode.cookieName) && ((a = document.querySelector("." + app.themePanel.class + " [" + app.themePanel.themeDarkMode.toggleAttr + "]")) && (a.checked = !0,
    a.onchange()));
    getCookie(app.themePanel.themeGradientEnabled.cookieName) && ((a = document.querySelector("." + app.themePanel.class + " [" + app.themePanel.themeGradientEnabled.toggleAttr + "]")) && (a.checked = !0,
    a.onchange()));
    getCookie(app.themePanel.themeSidebarGrid.cookieName) && ((a = document.querySelector("." + app.themePanel.class + " [" + app.themePanel.themeSidebarGrid.toggleAttr + "]")) && (a.checked = !0,
    a.onchange()));
    "false" == getCookie(app.themePanel.themeSidebarFixed.cookieName) && ((a = document.querySelector("." + app.themePanel.class + " [" + app.themePanel.themeSidebarFixed.toggleAttr + "]")) && (a.checked = !1,
    a.onchange()));
    "false" == getCookie(app.themePanel.themeHeaderFixed.cookieName) && ((a = document.querySelector("." + app.themePanel.class + " [" + app.themePanel.themeHeaderFixed.toggleAttr + "]")) && (a.checked = !1,
    a.onchange()));
    "true" == getCookie(app.themePanel.themeHeader.cookieName) && ((a = document.querySelector("." + app.themePanel.class + " [" + app.themePanel.themeHeader.toggleAttr + "]")) && (a.checked = !0,
    a.onchange()))
}
  , handleSavePanelPosition = function(e) {
    ...
    if (jQuery && 0 !== $("." + app.panel.sortable.class).length) {
        ...
        $.when($("." + app.panel.sortable.class).each((function() {
            ...
            $(e).find("[" + app.panel.sortable.spinnerAttr + "]").delay(500).fadeOut(500, (function() {
                $(this).remove()
            }
            ))
        }
                ...
                $.when($("." + app.panel.class + ":not([" + app.panel.sortable.disableAttr + "])").parent("[" + app.panel.sortable.parentAttr + "]").each((function() {
                    ...
                    e && $.each(e, (function(e, a) {
                        ...
                        if (0 !== $(t).length) {
                            ...
                            $(t).remove(),
                            $(s).append(l),
                            $("[" + app.panel.sortable.attr + '="' + a.id + '"]').attr("data-init", "true")
                        }
                    }
                    )),
                    t++
  ...
  , handleUnlimitedTabsRender = function() {
    function e(e, a) {
        ...
        case "next":
            ...
            c >= (i = i - 85) ? (d = i - n,
            u = !0) : c < i && (d = c - n),
            (m = t.querySelector("." + app.bootstrap.nav.tabs.class)).style.transitionProperty = "height, margin, padding",
            m.style.transitionDuration = app.animation.speed + "ms",
            "rtl" != s.getPropertyValue("direction") ? (m.style.marginLeft = "-" + d + "px",
            u && t.classList.remove(app.unlimitedTabs.overflowRight.class),
            t.classList.add(app.unlimitedTabs.overflowLeft.class)) : (m.style.marginRight = "-" + d + "px",
        ...
        case "prev":
            ...
            "rtl" != s.getPropertyValue("direction") ? (m.style.marginLeft = "-" + d + "px",
            t.classList.add(app.unlimitedTabs.overflowRight.class),
            b && t.classList.remove(app.unlimitedTabs.overflowLeft.class)) : (m.style.marginRight = "-" + d + "px",
        ...
        e && e.map((function(e) {
            !function(e, a) {
                ...
                var s = window.getComputedStyle(document.querySelector("body"))
                  ...
                  , r = (parseInt(o.getPropertyValue(l)),
                e.clientWidth)
                ...
                if (c && c.map((function(e) {
                    p += e.clientWidth,
                    d || (n += e.clientWidth),
                    e.querySelector(".nav-link").classList.contains("active") && (d = !0)
                }
                )),
                n >= r) {
                    var u = n - r;
                    ...
                    "rtl" == s.getPropertyValue("direction") ? m.style.marginRight = "-" + u + "px" : m.style.marginLeft = "-" + u + "px",
                    setTimeout((function() {
                        m.style.transitionProperty = "",
                        m.style.transitionDuration = ""
                    }
                ...
                n != p && p >= r ? e.classList.add(app.unlimitedTabs.overflowRight.class) : e.classList.remove(app.unlimitedTabs.overflowRight.class),
                n >= r && p >= r ? e.classList.add(app.unlimitedTabs.overflowLeft.class) : e.classList.remove(app.unlimitedTabs.overflowLeft.class)
            }(e, 0)
        }
        ))
    }
  ...
  , handleUnlimitedTopMenuRender = function() {
    ...
    function e(e, a) {
        ...
        case "next":
            ...
            ), app.animation.speed)) : p = n - r - m,
            0 !== p && (t.style.transitionProperty = "height, margin, padding",
            t.style.transitionDuration = app.animation.speed + "ms",
            "rtl" != l.getPropertyValue("direction") ? t.style.marginLeft = "-" + p + "px" : t.style.marginRight = "-" + p + "px",
            setTimeout((function() {
                t.style.transitionProperty = "",
                t.style.transitionDuration = "",
                t.querySelector("." + app.topMenu.control.class + "." + app.topMenu.control.buttonPrev.class).classList.add("show")
            }
            ), app.animation.speed));
            break;
        case "prev":
            var g;
            (g = -r) <= n ? (t.querySelector("." + app.topMenu.control.class + "." + app.topMenu.control.buttonPrev.class).classList.remove("show"),
            p = 0) : p = g - n + m,
            ...
            setTimeout((function() {
                t.style.transitionProperty = "",
                t.style.transitionDuration = "",
                t.querySelector("." + app.topMenu.control.class + "." + app.topMenu.control.buttonNext.class).classList.add("show")
            }
            ), app.animation.speed)
        }
    }
    function a() {
        ...
        if (e) {
            ...
            if (d) {
                var u = !1;
                d.map((function(e) {
                    e.classList.contains("menu-control") || (r += e.clientWidth,
                    u || (o += e.clientWidth),
            ...
            o != r && r >= l ? (m.classList.add(app.topMenu.control.showClass),
            c += p) : m.classList.remove(app.topMenu.control.showClass);
            m = e.querySelector("." + app.topMenu.control.class + "." + app.topMenu.control.buttonPrev.class);
            if (o >= l && r >= l ? m.classList.add(app.topMenu.control.showClass) : m.classList.remove(app.topMenu.control.showClass),
            o >= l) {
                var b = o - l + c;
    ...
    function s(e) {
        ...
        a.addEventListener("mousemove", (e=>{
            ...
            var p = o + 1 * (s - l);
            p <= i ? (p = i,
            t.querySelector("." + app.topMenu.control.class + "." + app.topMenu.control.buttonNext.class).classList.remove("show")) : t.querySelector("." + app.topMenu.control.class + "." + app.topMenu.control.buttonNext.class).classList.add("show"),
            n < a.offsetWidth && t.querySelector("." + app.topMenu.control.class + "." + app.topMenu.control.buttonPrev.class).classList.remove("show"),
            i > 0 && t.querySelector("." + app.topMenu.control.class + "." + app.topMenu.control.buttonNext.class).classList.remove("show"),
            p > 0 ? (p = 0,
            t.querySelector("." + app.topMenu.control.class + "." + app.topMenu.control.buttonPrev.class).classList.remove("show")) : t.querySelector("." + app.topMenu.control.class + "." + app.topMenu.control.buttonPrev.class).classList.add("show"),
  ...
  , handleTopMenuToggle = function(e, a=!1) {
    e.map((function(t) {
        t.onclick = function(t) {
            if (t.preventDefault(),
            !a || a && document.body.clientWidth < 768) {
                var s = this.nextElementSibling;
                e.map((function(e) {
                    var a = e.nextElementSibling;
                    a !== s && (slideUp(a),
                    a.closest("." + app.topMenu.menu.itemClass).classList.remove(app.topMenu.menu.expandClass),
                    a.closest("." + app.topMenu.menu.itemClass).classList.add(app.topMenu.menu.closedClass))
                }
                )),
                slideToggle(s)
            }
  ...
  , handleToggleNavProfile = function() {
    ...
    e && (e.onclick = function(e) {
        ...
        s && ("block" == s.style.display ? t.classList.remove(app.sidebar.menu.activeClass) : t.classList.add(app.sidebar.menu.activeClass),
        slideToggle(s, l),
        ...
        e.onclick = function(e) {
            ...
            var o = setInterval((function() {
                ...
                l) {
                    ...
                    if (o > c && u)
                        for (var m = app.sidebar.floatSubmenu.overflow.class.split(" "), b = 0; b < m.length; b++)
                            u.classList.add(m[b])
                }
            }
            ), 1);
            ...
            if (e && e.classList.contains(app.sidebar.minify.toggledClass)) {
                ...
                if (t) {
                    ...
                    if (document.querySelector(app.sidebar.floatSubmenu.id)) {
                        ...
                        if (i > m && g)
                            for (var h = app.sidebar.floatSubmenu.overflow.class.split(" "), f = 0; f < h.length; f++)
                                g.classList.add(h[f]);
                        ...
                        v.setAttribute("id", app.sidebar.floatSubmenu.id.replace("#", "")),
                        v.setAttribute("class", app.sidebar.floatSubmenu.container.class),
                        v.setAttribute("data-offset-top", p),
                        v.setAttribute("data-menu-offset-top", p),
                        v.innerHTML = '\t<div class="' + app.sidebar.floatSubmenu.arrow.class + '" id="' + app.sidebar.floatSubmenu.arrow.id.replace("#", "") + '"></div>\t<div class="' + app.sidebar.floatSubmenu.line.class + '" id="' + app.sidebar.floatSubmenu.line.id.replace("#", "") + '"></div>\t<div class="' + app.sidebar.floatSubmenu.class + " " + y + '">' + t + "</div>",
                        e.appendChild(v);
                    ...
                    i = document.querySelector(app.sidebar.floatSubmenu.id).clientHeight,
  ...
  , handleAjaxMode = function() {
    ...
    return {
        ...
        initDefaultUrl: function() {
            if (this.emptyHtml = e && e.emptyHtml ? e.emptyHtml : app.ajax.error.html,
            ...
            "" === this.defaultUrl) {
                ...
                this.renderAjax(this.defaultUrl, "", !0)
        },
        ...
        clearElement: function() {
            ...
            var s;
            if ((s = document.getElementById(app.sidebar.floatSubmenu.id)) && s.remove(),
            jQuery && $.fn.DataTable)
                try {
        ...
        checkSidebarActive: function(e) {
            ...
            if (a) {
                ...
                (t = getParents(a)) && t.map((function(e) {
        ...
        checkClearOption: function() {
            app.ajax.clearOption && (App.clearPageOption(app.ajax.clearOption),
        ...
        checkLoading: function(e) {
            if (e) {
                ...
                a && a.remove(),
                (t = document.querySelector("." + app.content.class)) && t.classList.remove("position-relative"),
                document.body.classList.remove(app.ajax.loader.class)
            } else {
                var t;
                if (!document.querySelector(app.ajax.loader.id))
                    if (document.body.classList.add(app.ajax.loader.class),
                    t = document.querySelector("." + app.content.class)) {
                        var s = document.createElement("div");
                        s.setAttribute("id", app.ajax.loader.id.replace("#", "")),
                        s.setAttribute("class", "position-absolute top-0 bottom-0 start-0 end-0 bg-light bg-opacity-75"),
                        s.style.zIndex = 9999,
        ...
        renderAjax: function(a, t, s) {
            ...
            if (l) {
                ...
                t && (n = t.getAttribute("data-type") ? t.getAttribute("data-type") : n,
                targetDataDataType = t.getAttribute("data-data-type") ? t.getAttribute("data-data-type") : n);
                var i = new XMLHttpRequest;
                i.onreadystatechange = function() {
                    i.readyState == XMLHttpRequest.DONE && (200 == i.status ? setInnerHTML(l, i.responseText) : 400 == i.status ? (console.log("There was an error 400"),
                    setInnerHTML(l, emptyHtml)) : console.log("something else other than 200 was returned"),
  ...
  , handleSetPageOption = function(e) {
    ...
    if (a) {
        if (e.appContentFullHeight && a.classList.add(app.content.fullHeight.class),
        e.appSidebarLight) {
        ...
        var s;
        if (e.appSidebarEnd && a.classList.add(app.layout.sidebarEnd.class),
        e.appSidebarWide && a.classList.add(app.layout.sidebarWide.class),
        e.appSidebarMinified && a.classList.add(app.layout.sidebarMinified.class),
        e.appSidebarTwo)
            a.classList.add(app.layout.sidebarTwo.class),
            a.classList.add(app.sidebarEnd.toggledClass),
            (s = document.querySelector("." + app.header.class + " [" + app.sidebarEnd.mobile.toggleAttr + "]")) && s.classList.remove(app.helper.display.none),
            (s = document.querySelector("." + app.header.class + " ." + app.header.brand.class)) && s.classList.remove(app.helper.margin.left[0]);
        if (e.appSidebarTransparent)
            (s = document.querySelector("." + app.sidebar.class)) && s.classList.add(app.sidebar.transparent.class);
        if (e.appSidebarSearch)
            (s = document.querySelector("." + app.sidebar.class + " ." + app.sidebar.search.class)) && s.classList.remove(app.sidebar.search.hideClass);
        if (e.appSidebarHover && a.classList.add(app.sidebar.hover.class),
        e.appTopMenu)
            a.classList.add(app.layout.topMenu.class),
            (s = document.querySelector("." + app.header.class + " [" + app.topMenu.mobile.toggleAttr + "]")) && s.classList.remove(app.helper.display.none);
        if (e.appWithoutHeader)
            a.classList.add(app.layout.withoutHeader.class),
            (s = document.querySelector("." + app.header.class)) && (s.style.display = "none");
        if (e.appWithoutSidebar)
            a.classList.add(app.layout.withoutSidebar.class),
            (s = document.querySelector("." + app.header.class + " [" + app.sidebar.mobile.toggleAttr + "]")) && s.classList.add(app.helper.display.none),
            (s = document.querySelector("." + app.sidebar.class)) && (s.style.display = "none"),
            (s = document.querySelector("." + app.sidebar.bg.class)) && (s.style.display = "none"),
            (s = document.querySelector("." + app.sidebar.mobile.backdrop.class)) && (s.style.display = "none");
        if (e.appHeaderInverse)
            (s = document.querySelector("." + app.header.class)) && s.setAttribute(app.darkMode.attr, app.darkMode.value);
        if (e.pageContentFullWidth)
            (s = document.querySelector("." + app.content.class)) && s.classList.add(app.content.fullWidth.class);
        if (e.appClass)
            for (var l = e.appClass.split(" "), o = 0; o < l.length; o++)
                a.classList.add(l[o]);
        if (e.appContentClass)
            if (s = document.querySelector("." + app.content.class))
                for (l = e.appContentClass.split(" "),
                o = 0; o < l.length; o++)
                    s.classList.add(l[o]);
        if (e.bodyClass)
            for (l = e.bodyClass.split(" "),
            o = 0; o < l.length; o++)
                document.body.classList.add(l[o]);
        e.appBoxedLayout && document.body.classList.add(app.layout.boxedLayout.class),
  ...
  , handleClearPageOption = function(e) {
    var a = document.querySelector("." + app.class);
    if (a) {
        if (e.appContentFullHeight && a.classList.remove(app.content.fullHeight.class),
        e.appSidebarLight) {
            var t = document.querySelector("." + app.class + " ." + app.sidebar.class + ":not(." + app.sidebarEnd.class + ")");
            if (!t)
                return;
        ...
        var s;
        if (e.appSidebarEnd && a.classList.remove(app.layout.sidebarEnd.class),
        e.appSidebarWide && a.classList.remove(app.layout.sidebarWide.class),
        e.appSidebarMinified && a.classList.remove(app.layout.sidebarMinified.class),
        e.appSidebarTwo)
            a.classList.remove(app.layout.sidebarTwo.class),
            a.classList.remove(app.sidebarEnd.toggledClass),
            (s = document.querySelector("." + app.header.class + " [" + app.sidebarEnd.mobile.toggleAttr + "]")) && s.classList.add(app.helper.display.none),
            (s = document.querySelector("." + app.header.class + " ." + app.header.brand.class)) && s.classList.add(app.helper.margin.left[0]);
        if (e.appSidebarTransparent)
            (s = document.querySelector("." + app.sidebar.class)) && s.classList.remove(app.sidebar.transparent.class);
        if (e.appSidebarSearch)
            (s = document.querySelector("." + app.sidebar.class + " ." + app.sidebar.search.class)) && s.classList.add(app.sidebar.search.hideClass);
        if (e.appSidebarHover && a.classList.remove(app.sidebar.hover.class),
        e.appTopMenu)
            a.classList.remove(app.layout.topMenu.class),
            (s = document.querySelector("." + app.header.class + " [" + app.topMenu.mobile.toggleAttr + "]")) && s.classList.add(app.helper.display.none);
        if (e.appHeaderInverse)
            (s = document.querySelector("." + app.header.class)) && s.removeAttribute(app.darkMode.attr);
        if (e.appWithoutSidebar)
            a.classList.remove(app.layout.withoutSidebar.class),
            (s = document.querySelector("." + app.header.class + " [" + app.sidebar.mobile.toggleAttr + "]")) && s.classList.remove(app.helper.display.none),
            (s = document.querySelector("." + app.sidebar.class)) && s.removeAttribute("style"),
            (s = document.querySelector("." + app.sidebar.bg.class)) && s.removeAttribute("style"),
            (s = document.querySelector("." + app.sidebar.mobile.backdrop.class)) && s.removeAttribute("style");
        if (e.appWithoutHeader)
            a.classList.remove(app.layout.withoutHeader.class),
            (s = document.querySelector("." + app.header.class)) && s.removeAttribute("style");
        if (e.appContentFullWidth)
            (s = document.querySelector("." + app.content.class)) && s.classList.remove(app.content.fullWidth.class);
        if (e.appContentClass)
            if (s = document.querySelector("." + app.content.class))
                for (var l = e.appContentClass.split(" "), o = 0; o < l.length; o++)
                    s.classList.remove(l[o]);
        if (e.appClass)
            for (l = e.appClass.split(" "),
            o = 0; o < l.length; o++)
  ...
  , handleAnimation = function() {
    ...
    e && e.map((function(e) {
        ...
        case "height":
            ...
            break;
        case "number":
            for (var s = e, l = countDecimals(t), o = l; o > 0; )
                10,
                o--;
            const a = ()=>{
                const e = +t.replace(",", "")
                ...
                if (o < e) {
                    ...
                    s.innerText = convertNumberWithCommas(e)
            }
            ;
            a();
            break;
        ...
        e.onkeyup = function() {
            ...
            (e = [].slice.call(document.querySelectorAll("." + app.sidebar.class + ":not(." + app.sidebarEnd.class + ") ." + app.sidebar.menu.class + " > ." + app.sidebar.menu.itemClass + ":not(." + app.sidebar.profile.class + "):not(." + app.sidebar.menu.headerClass + "):not(." + app.sidebar.search.class + ") > ." + app.sidebar.menu.itemLinkClass + ", ." + app.sidebar.class + " ." + app.sidebar.menu.submenu.class + " > ." + app.sidebar.menu.itemClass + " > ." + app.sidebar.menu.itemLinkClass))) && e.map((function(e) {
                ...
                if ((t = t.toLowerCase()).search(a) > -1) {
                    var s;
                    if ((s = e.closest("." + app.sidebar.menu.itemClass)) && (s.classList.remove(app.sidebar.search.hideClass),
                    s.classList.add(app.sidebar.search.foundClass)),
                    s = e.closest("." + app.sidebar.menu.itemClass + "." + app.sidebar.menu.hasSubClass))
                        (s = s.querySelector("." + app.sidebar.menu.submenu.class + " ." + app.sidebar.menu.itemClass + "." + app.sidebar.search.hideClass)) && s.classList.remove(app.sidebar.search.hideClass);
                    if (s = e.closest("." + app.sidebar.menu.submenu.class))
                        if (s.style.display = "block",
                        (s = s.querySelector("." + app.sidebar.menu.itemClass + ":not(." + app.sidebar.search.foundClass + ")")) && s.classList.add(app.sidebar.search.hideClass),
                        s = e.closest("." + app.sidebar.menu.hasSubClass + ":not(." + app.sidebar.search.foundClass + ")"))
                            s.classList.remove(app.sidebar.search.hideClass),
                            s.classList.add(app.sidebar.menu.expandClass),
                            (s = s.closest("." + app.sidebar.menu.hasSubClass + ":not(." + app.sidebar.search.foundClass + ")")) && (s.classList.remove(app.sidebar.search.hideClass),
                            s.classList.add(app.sidebar.menu.expandClass))
                }
            }
  ...
  , hexToRgba = function(e, a=1, t=!1) {
    ...
    if (/^#([A-Fa-f0-9]{3}){1,2}$/.test(e))
        return 3 == (s = e.substring(1).split("")).length && (s = [s[0], s[0], s[1], s[1], s[2], s[2]]),
        "rgba(" + [(s = "0x" + s.join("")) >> 16 & 255, s >> 8 & 255, 255 & s].join(",") + "," + a + ")";
    if (!t)
        return e = stringToColor(e),
        hexToRgba(e, a, !0);
  ...
  , handleCssVariable = function() {
    ...
    if (app.variableFontList && app.variablePrefix)
        for (var a = 0; a < app.variableFontList.length; a++)
            app.font[app.variableFontList[a].replace(/-([a-z|0-9])/g, ((e,a)=>a.toUpperCase()))] = e.getPropertyValue("--" + app.variablePrefix + app.variableFontList[a]).trim();
    if (app.variableColorList && app.variablePrefix)
        for (a = 0; a < app.variableColorList.length; a++)
            app.color[app.variableColorList[a].replace(/-([a-z|0-9])/g, ((e,a)=>a.toUpperCase()))] = e.getPropertyValue("--" + app.variablePrefix + app.variableColorList[a]).trim()
}
...
"loading" !== document.readyState ? (App.init(),
App.restartGlobalFunction()) : document.addEventListener("DOMContentLoaded", (function() {
    App.init(),
