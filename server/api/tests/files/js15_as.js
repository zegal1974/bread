;(function () {
    ...
    l = function (n, r) {
      ...
      try {
        var o = r.document,
          ...
          w = function (n) {
            return 'string' != typeof n || n.length < 1
              ? n
              : n.replace(/^['"]?(.*)['"]$/, '$1')
          },
        ...
        var X = 'https://',
          ...
          sn = function (n) {
            return (
              '<script type="text/javascript" language="JavaScript" >document.writeln(\'' +
              n +
              "');</script>"
            )
          },
              ...
              e &&
                ...
                (e.readyState
                  ? (e.onreadystatechange = function () {
                      var n = e.readyState
                      ;('loaded' == n || 'complete' == n || parseInt(n) > 1) &&
                        ((e.onreadystatechange = null), t(r))
                    })
        ...
        ;(i.SC = Mn),
          ...
          (i.init = function () {
            if (!i.o_i) {
              ...
              ;(i.o_n = n.getTime()),
                (i.n_a = a.appName),
                ('Opera' === i.n_a || a.userAgent.indexOf('Firefox') >= 0) &&
                  (i.n_f = 1),
              ...
              if (
                ...
                (i.d_fa = g(Gn('HstCfa'))),
                g(Gn('NoHits') > 0) && gn(),
                i.d_fa < 1 && ((i.d_fa = i.o_n), qn('HstCfa', i.d_fa)),
                (i.d_nv = 1),
                qn('HstCla', i.o_n),
                (i.c_on = g(Gn('HstCla'))),
                i.c_on > 0)
                ...
                var o = 1e3,
                  ...
                  _ = 600 * o,
                  f = 45 * o
                parseInt(i.o_n - i.d_mu) >= u &&
                  (qn('HstCmu', i.o_n), (i.d_mu = 0)),
                  i.d_mu++,
                  j < 1 || F >= u
                    ? ((i.d_pn = 1), (i.d_cv = 1), (i.d_pt = 1), (i.d_cs = 1))
                    : F > 0 &&
                      (F < c ? (i.d_nv = 0) : ((i.d_pn = 1), i.d_cv++),
                      F > _ && i.d_cs++),
                  i.d_cv < 1 && (i.d_cv = 1),
                  1 == i.d_nv &&
              ...
              D(N) && 1 == i.d_nv && t < 1
                ? qn('c_ref_', xn(N))
                : (D(kn(Un('c_ref_' + wn()))) && (N = kn(Un('c_ref_' + wn()))),
                  D(N) || (N = '1000')),
                (i.d_op = Un('c_pd_' + wn())),
                y(i.d_op) || (i.d_op = 0),
          ...
          Yn = function () {
            i.init(),
              (U =
                ...
                ('&@b1:' + H()) +
                ('&@b3:' + Jn()) +
                ('&@b4:' + xn('undefined' != typeof e ? e : 'err')) +
                ('&@b5:' + zn()) +
                ('&@a' + xn(_)) +
                ('&@v' + xn(i.s_u)))
          }
        ;(i.add_v = function (n, t) {
          D(n) &&
            D(t) &&
            ('tags' == n && (t = t.split(';').join(',')),
            (i.a_va[g(i.a_va.length)] = xn(n) + '=' + xn(t)))
        }),
          (i.imp_v = function () {
            var n = '0'
        ...
        ;(i.load_JScall = Kn),
          ...
          (i.track_hits = function () {
            yn() ||
              (Yn(),
              J()
                ? ((B = 'i/' + wn() + '.gif?'), i.load_gifImgOrTopImg())
                : z()
                ? ((B = L() + '.gif?'), i.load_GIFicon())
                : q() || W()
                ? (tt('1'), (B = '0.php?'), Kn(), lt())
                : ((B = wn() + '.php?'), Kn()))
          })
        ...
        var _t = { counterObjInstance: void 0 },
          ft = function () {
            return { main_div_name: Bn(), siteId: wn() }
          },
          dt = function () {
            var n = ct(L())
            ln(n, function () {
              var n = r[at(L())],
                t = Rn()
              t &&
                ((_t.counterObjInstance = n(ft(), r)),
                null != _t.counterObjInstance && _t.counterObjInstance.start())
            })
          },
          pt = function (n) {
            return n > 0 && n < 400
  ...
  ;(o = t(window[y]) && 1 == window[y]),
    ...
    (i = i || o || a),
    i &&
      ((window['histats_counters_byType'] =
        window['histats_counters_byType'] || {}),
      (window['histats_counters_byType'][r] =
        window['histats_counters_byType'][r] || []),
      window['histats_counters_byType'][r].push(e)),
    o && (h = {}),
    a && (m = window['mocked_window']),
    i
      ? s
        ? (window['histatsByName_' + e] = l)
        : (window['histatsByName_' + e] = l(h, m))
      : (window['Histats'] = l(h, m))
}.call(this))
