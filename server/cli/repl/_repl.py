...
def repl(
        old_ctx, prompt_kwargs=None, allow_system_commands=True, allow_internal_commands=True
):
    """
    ...
    :param allow_system_commands: allow_system_commands
    :param allow_internal_commands: allow_internal_commands
